...
const carCategories = [
    { id: 'city', name: 'City', examples: 'Fiat 500, VW Polo', price: 45 },
    { id: 'family', name: 'Family', examples: 'VW Touran, Skoda Octavia', price: 70 },
    { id: 'suv', name: 'SUV', examples: 'VW Tiguan, Volvo XC60', price: 90 },
    { id: 'sport', name: 'Sport', examples: 'BMW Z4, Audi TT', price: 120 },
    { id: 'ecar', name: 'E-Car', examples: 'Tesla Model 3, Renault Zoe', price: 100 },
];
